...
const retryDelay = parseInt(getArg('retryDelay', '3000'), 10);
const openReport = getArg('openReport', 'false') === 'true';
...
// // command:
// // PS B:\INTERVIEW PREPARATION 19 FEB 2025\CypressAutomationProject\CypressOrangeHRMProject\OrangeHRMAutomation> node runAllTestsWithReports.js --retryCount=2 --retryDelay=5000 --browser=edge --headed=true


// // PS B:\INTERVIEW PREPARATION 19 FEB 2025\CypressAutomationProject\CypressOrangeHRMProject\OrangeHRMAutomation> node runAllTestsWithReports.js --retryCount=2 --retryDelay=5000 --browser=chrome --headed

//// To open reports in browser:
//// node runAllTestsWithReports.js --retryCount=2 --retryDelay=5000 --browser=chrome --headed --openReport=true

//// To skip opening reports in browser:
//// node runAllTestsWithReports.js --retryCount=2 --retryDelay=5000 --browser=chrome --headed
